...
// 'admin_id','username','phone','email','address','status','password'
  ...
  if(isset($_POST['submit'])){
    ...
    if(User::find($user->user_id)) {
      ($user->update()) ? $msg = 'Successful': $msg = 'Failed';
    } 
  }
          ...
          <form  action='Edit_user.php' method='post'>
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Name" name="username" id="name" value="<?php echo $user->username; ?>"  required data-validation-required-message="Please enter your name.">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                ...
                <input type="email" class="form-control" name="email" placeholder="Email Address" id="email" value="<?php echo $user->email; ?>" required data-validation-required-message="Please enter your email address.">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
