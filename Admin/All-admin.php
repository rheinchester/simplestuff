                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header ">
                                ...
                                <a class='btn btn-success col-md-offset-10' href='add_admin.php'>Add</a>
                            ...
                            <tr>
                                ...
                                <td>{$admin->phone}</td>
                                <td>
                                    <a class='btn btn-info' href='Edit_admin.php?id={$admin->admin_id}'>Edit</a>
                                </td>
                                <td>
                                    <a class='btn btn-danger' href='All-admin.php?id={$admin->admin_id}&opt=0'>Delete</a>
